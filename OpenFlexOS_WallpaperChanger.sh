...
# GUI Menu using zenity
    CHOICE=$(zenity  --width=500 --height=400 --list --title="Wallpaper Manager" --column="Options" "Select Wallpaper" "Select Random Wallpaper" "$MENU_OPTION" "SlideShow" "Mutli-Monitor Wallpapers")
    case "$CHOICE" in
        "Select Wallpaper")
            Select_Wallpaper
        ;; 
        ...
        "Start Wallpaper Cycle")
            INTERVAL=$(zenity  --width=500 --height=400 --list --title="Set Wallpaper Interval" --column="Options" \
